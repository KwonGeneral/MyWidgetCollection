...
//
//
//class BackupModeFragment : Fragment() {
...
//
//        val vv = MockExamRecord.MockExamDataList().apply {
//            subjects.add(MockExamRecord.MockExamData("국어", 40, 100))
//            subjects.add(MockExamRecord.MockExamData("수학", 80, 60))
//            subjects.add(MockExamRecord.MockExamData("영어", 60, 90))
//            subjects.add(MockExamRecord.MockExamData("사회", 30, 70))
//        }
//        val ss: MockExamRecord.MockExamData = Gson().fromJson(Gson().toJson(vv), MockExamRecord.MockExamData::class.java)
//        val uu = Gson().toJson(vv)
//        var kk = MockExamRecord(
//            id = 0,
//            title = "타이틀",
//            description = "설명",
//            create_at = 0,
