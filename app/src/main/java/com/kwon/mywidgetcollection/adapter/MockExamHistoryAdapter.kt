...
import kotlinx.android.synthetic.main.list_item_exam_history.view.*
import kotlinx.android.synthetic.main.list_item_record_pager.view.*
import java.text.SimpleDateFormat
import java.util.*

class MockExamHistoryAdapter constructor(var context: Context, var items:List<MockExamRecord>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return VH(LayoutInflater.from(context).inflate(R.layout.list_item_exam_history, parent, false))
    }
